...
/**
 * CreateTenantMessageProcessor invokes the {@link org.mule.modules.cloudhub.CloudHubConnector#createTenant(com.mulesoft.ch.rest.model.Tenant, java.lang.String)} method in {@link CloudHubConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.2", date = "2015-11-24T09:26:58-03:00", comments = "Build 3.7.x.2633.51164b9")
public class CreateTenantMessageProcessor
    extends DevkitBasedMessageProcessor
    implements MessageProcessor, OperationMetaDataEnabled
{

    protected Object tenant;
    protected Tenant _tenantType;
    protected Object domain;
    protected String _domainType;

    public CreateTenantMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final Tenant _transformedTenant = ((Tenant) evaluateTransformForPayload(getMuleContext(), event, CreateTenantMessageProcessor.class.getDeclaredField("_tenantType").getGenericType(), null, tenant));
            final String _transformedDomain = ((String) evaluateAndTransform(getMuleContext(), event, CreateTenantMessageProcessor.class.getDeclaredField("_domainType").getGenericType(), null, domain));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((CloudHubConnector) object).createTenant(_transformedTenant, _transformedDomain);
                }
    ...
    public Result<MetaData> getInputMetaData() {
        MetaDataModel metaDataPayload = getPojoOrSimpleModel(Tenant.class);
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CloudHubConnector at createTenant retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
