...
/**
 * GetApplicationMessageProcessor invokes the {@link org.mule.modules.cloudhub.CloudHubConnector#getApplication(java.lang.String)} method in {@link CloudHubConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedDomain = ((String) evaluateAndTransform(getMuleContext(), event, GetApplicationMessageProcessor.class.getDeclaredField("_domainType").getGenericType(), null, domain));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((CloudHubConnector) object).getApplication(_transformedDomain);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at CloudHubConnector at getApplication retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
